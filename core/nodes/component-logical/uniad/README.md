...
Configures unified anomaly detection features.
...
|---|---|---|---|---|---|---|
| `backbone` | `select` | `efficientnet-b4` | — | — | `efficientnet-b4`, `resnet50` | Backbone |

## Workflow use

1. Add **UniAD** from **Component/logical** in Workflow editor.
