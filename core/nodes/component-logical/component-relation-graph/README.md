# Component relation graph node

## Purpose

Scores configured spatial and logical component relations.

## Runtime contract

| Field | Value |
|---|---|
| Node ID | `component-relation-graph` |
...
|---|---|---|---|---|---|
| `detections` | input | `detections` | yes | no | Components |
...
|---|---|---|---|---|---|---|
| `relationTolerance` | `number` | `0.1` | `0.0` | `1.0` | — | Relation tolerance |

## Workflow use

1. Add **Component relation graph** from **Component/logical** in Workflow editor.
2. Connect typed inputs: `detections`.
3. Configure parameters within listed limits.
4. Connect outputs: `score`, `decision`.
