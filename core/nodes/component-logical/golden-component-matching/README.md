# Golden component matching node

## Purpose

Matches configured component instances with golden evidence.

## Runtime contract

| Field | Value |
|---|---|
| Node ID | `golden-component-matching` |
...
|---|---|---|---|---|---|---|
| `matchThreshold` | `number` | `0.8` | `0.0` | `1.0` | — | Match threshold |

## Workflow use

1. Add **Golden component matching** from **Component/logical** in Workflow editor.
