...
Configures efficient student–teacher anomaly scoring.
...
|---|---|---|---|---|---|---|
| `modelSize` | `select` | `small` | — | — | `small`, `medium` | Model size |

## Workflow use

1. Add **EfficientAD** from **Student–teacher** in Workflow editor.
