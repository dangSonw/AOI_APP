...
Configures student–teacher feature pyramid matching.
...
|---|---|---|---|---|---|---|
| `backbone` | `select` | `resnet18` | — | — | `resnet18`, `wide-resnet50` | Backbone |

## Workflow use

1. Add **STFPM** from **Student–teacher** in Workflow editor.
