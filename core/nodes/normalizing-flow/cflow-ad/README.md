...
Configures conditional normalizing-flow anomaly detection.
...
|---|---|---|---|---|---|---|
| `couplingBlocks` | `integer` | `8` | `1` | `128` | — | Coupling blocks |

## Workflow use

1. Add **CFLOW-AD** from **Normalizing flow** in Workflow editor.
