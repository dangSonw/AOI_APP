...
Resizes an image to configured dimensions.
...
|---|---|---|---|---|---|---|
| `width` | `integer` | `1024` | `1` | `16384` | — | Width |
| `height` | `integer` | `1024` | `1` | `16384` | — | Height |
| `interpolation` | `select` | `linear` | — | — | `nearest`, `linear`, `cubic`, `area` | Interpolation |

## Workflow use

1. Add **Resize** from **OpenCV tools** in Workflow editor.
