...
Applies a configured Gaussian smoothing kernel.
...
|---|---|---|---|---|---|---|
| `kernelSize` | `integer` | `5` | `1` | `255` | — | Kernel size |
| `sigma` | `number` | `1.0` | `0.0` | `1000.0` | — | Sigma |

## Workflow use

1. Add **Gaussian blur** from **OpenCV tools** in Workflow editor.
