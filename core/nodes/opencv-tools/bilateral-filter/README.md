...
Smooths while preserving configured edges.
...
|---|---|---|---|---|---|---|
| `diameter` | `integer` | `9` | `1` | `255` | — | Diameter |
| `sigmaColor` | `number` | `75.0` | `0.0` | `10000.0` | — | Color sigma |
| `sigmaSpace` | `number` | `75.0` | `0.0` | `10000.0` | — | Space sigma |

## Workflow use

1. Add **Bilateral filter** from **OpenCV tools** in Workflow editor.
