...
Scores pixels against configured multivariate normal statistics.
...
|---|---|---|---|---|---|---|
| `regularization` | `number` | `0.001` | `1e-07` | `1.0` | — | Regularization |

## Workflow use

1. Add **Per-pixel Mahalanobis distance** from **Golden/reference** in Workflow editor.
