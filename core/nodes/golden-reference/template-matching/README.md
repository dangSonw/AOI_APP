...
Matches configured templates against an image.
...
|---|---|---|---|---|---|---|
| `method` | `select` | `ccoeff-normed` | — | — | `sqdiff`, `sqdiff-normed`, `ccorr-normed`, `ccoeff-normed` | Method |

## Workflow use

1. Add **Template matching** from **Golden/reference** in Workflow editor.
