...
Scores absolute deviation from configured normal reference.
...
|---|---|---|---|---|---|---|
| `referenceAsset` | `text` | `golden` | — | — | — | Reference asset |

## Workflow use

1. Add **Absolute difference** from **Golden/reference** in Workflow editor.
