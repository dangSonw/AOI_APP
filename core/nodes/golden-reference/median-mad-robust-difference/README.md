...
Uses median and MAD reference statistics for robust deviation scoring.
...
|---|---|---|---|---|---|---|
| `epsilon` | `number` | `0.001` | `1e-07` | `1.0` | — | Epsilon |

## Workflow use

1. Add **Median–MAD robust difference** from **Golden/reference** in Workflow editor.
