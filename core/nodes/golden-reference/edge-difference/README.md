...
Compares edge evidence with a configured reference.
...
|---|---|---|---|---|---|---|
| `threshold` | `number` | `0.2` | `0.0` | `1.0` | — | Edge threshold |

## Workflow use

1. Add **Edge difference** from **Golden/reference** in Workflow editor.
