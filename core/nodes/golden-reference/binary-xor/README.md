...
Compares binary evidence using exclusive OR.
...
1. Add **Binary XOR** from **Golden/reference** in Workflow editor.
2. Connect typed inputs: `mask`, `reference`.
3. Configure parameters within listed limits.
4. Connect outputs: `difference-mask`, `score`.
