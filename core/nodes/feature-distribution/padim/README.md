...
Configures patch distribution modeling.
...
|---|---|---|---|---|---|---|
| `embeddingDimension` | `integer` | `100` | `1` | `100000` | — | Embedding dimension |

## Workflow use

1. Add **PaDiM** from **Feature distribution** in Workflow editor.
