...
Configures a representative patch memory bank.
...
|---|---|---|---|---|---|---|
| `memoryBankSize` | `integer` | `10000` | `1` | `10000000` | — | Memory bank size |
| `coresetRatio` | `number` | `0.1` | `0.0001` | `1.0` | — | Coreset ratio |

## Workflow use

1. Add **PatchCore** from **Feature distribution** in Workflow editor.
