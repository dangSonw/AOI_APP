...
Configures DINO feature anomaly scoring.
...
|---|---|---|---|---|---|---|
| `backbone` | `select` | `dinov2-small` | — | — | `dinov2-small`, `dinov2-base`, `dinov2-large` | Backbone |

## Workflow use

1. Add **AnomalyDINO** from **Feature distribution** in Workflow editor.
